...
-----END PRIVATE KEY-----`
        ...
        test('generateSignature', () => {
            ...
            const snapInstance = new Snap(options);
            const signature = snapInstance.generateSignature();
            expect(signature).toHaveProperty('signatureResult');
            expect(signature).toHaveProperty('xTimestamp');
            expect(signature).toHaveProperty('clientID');
        });
    });

    describe('generateTimestamp', () => {
        test('generateTimestamp', () => {
            const timestamp = snap.generateTimestamp();
